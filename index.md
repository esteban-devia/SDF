...
<body>
    <header>
        <div class="menu">
            <div class="logo">
                ...
                <a href="index.html" id="sfl-logo">
                    <img src="imgs/header/sfl-logo.png" alt="sfl-logo">
                </a>
            </div>
            <nav class="menu-list">
                ...
                <hr>
                <a href="javascript:void(0)" class="country-nav" onclick="openCountry(1)">PAÍS<img src="imgs/header/down-arrow.png" alt="down arrow"></a>
                <div class="country-block">
                    ...
                    <div class="country-list">
                        ...
                        <a href="#"><img src="imgs/header/Peru.png" alt="">
                            <p>COSTA RICA</p>
                        </a>
                    </div>
                </div>
                <div class="follow">
                    <p>SÍGUENOS</p>
                    <a href="https://www.instagram.com/?hl=es-la" target="_blank" class="social">
            ...
            <div class="registry-mob" onclick="openRegister()">
                <a class="register">REGISTRO</a>
            </div>
    ...
    <section class="index menpos">
        <div class="slider">
            <div class="slider-second">
                <a class="prev" onclick="plusSlide(-1)"><img src="imgs/home/left-arrow.png" alt=""></a>
                <div class="main-img">
                    <img src="imgs/home/caja-fondo.png" alt="">
                    <img src="imgs/home/Caja-borde.png" alt="">
                    <img src="imgs/home/caja-main-SDFP.png" alt="" class="prodboxmain">
                    <a href="sal-de-frutas-plus.html">SAL DE FRUTAS LUA PLUS &#10095;</a>
                </div>
                <div class="main-img">
                    <img src="imgs/home/caja-fondo-lua.png" alt="">
                    <img src="imgs/home/Caja-borde-lua.png" alt="">
                    <img src="imgs/home/caja-main-SDFL.png" alt="" class="prodboxmain">
                    <a href="sal-de-frutas-lua.html">SAL DE FRUTAS LUA &#10095;</a>
                </div>
                <div class="main-img video">
                    <video src="videos/sal-de-frutas-lua-colombia-2019.mp4" controls autoplay></video>
                    <!-- <iframe src="https://www.youtube.com/embed/XvENZmRjABk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                </div>
                <a class="next" onclick="plusSlide(1)"><img src="imgs/home/right-arrow.png" alt=""></a>
                <div class="mini d-none">
                    <picture class="mini-box">
                        <source media="(max-width: 900px)" srcset="imgs/home/caja-main-SDFL.png">
                        <img src="imgs/home/caja-main-SDFL.png" alt="">
                    </picture>
                    <picture class="mini-box">
                        <source media="(max-width: 900px)" srcset="imgs/home/caja-main-SDFP.png">
                        <img src="imgs/home/caja-main-SDFP.png" alt="">
                    </picture>
                    <picture class="mini-box">
        ...
        <div class="splash"><img src="imgs/home/splash.png" alt=""></div>
    </section>
    <section class="registry-form">
        <div class="alert-mob">
            <div class="back-mob back-reg">
                <a href=""><img src="imgs/home/left-arrow.png" alt=""></a>
            </div>
                        ...
                        <form action="" name="registryForm" id="registryForm" class="form-reg" autocomplete="off">
                            ...
                            <div class="check-reg">
                                <div class="checkterms">
                                    ...
                                    <label for="tyc">Acepto <a href="terminos.html">términos y condiciones</a> y las <a href="terminos.html">políticas de tratamiento de datos*</a></label>
                                </div>
                            </div>
    ...
    <footer>
        <div>
            ...
            <a href="terminos.html"><strong>Términos y Condiciones</strong></a>
            <a href="contacto.html"><strong>Contáctenos</strong></a>
            <span><strong>Todos los derechos reservados Sal de Frutas LUA</strong></span>
        </div>
        <span class="footer-mob">Todos los derechos reservados Sal de Frutas LUA</span>
        <p>Indicado para la indigestión, pesadez, llenura, distensión abdominal y gases. Es un medicamento, no exceder su consumo. Leer indicaciones y contraindicaciones en el empaque. Si los síntomas persisten consulte con su médico. Medicamento de venta
            libre. Reg. San. Invima 2018m-0013340-r1</p>
    </footer>
